...
export const Programacao2026Section = () => {
  return (
    <section id="programacao-2026" className="section-padding relative overflow-hidden bg-gradient-to-b from-background via-secondary/20 to-background">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {programacoes2026.map((prog, index) => (
            <article
              key={prog.id}
              className="group card-elevated overflow-hidden animate-fade-in-up bg-card/90 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-all duration-300"
