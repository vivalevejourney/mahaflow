...
export const programacoes2026: Programacao[] = [
  ...
  {
    id: 'cachoeira-bicuda',
    slug: 'cachoeira-bicuda',
    nome: 'Cachoeira da Bicuda Grande',
    data: '31 de janeiro',
    dataISO: '2026-01-31',
    dataCompleta: '31 de janeiro de 2026',
    diaSemana: 'Sábado',
    localPartida: 'Campos dos Goytacazes',
    conceito: 'Um dia de banho de cachoeira na Serra Macaense para se refrescar, respirar, se conectar e simplesmente estar presente.',
    oQueVaiViver: [
      'Paisagens exuberantes da Serra Macaense',
      'Contato intenso com a Mata Atlântica',
      'Tempo para curtir a cachoeira Bicuda Grande',
      'Possibilidade de aproveitar a gastronomia local',
    ],
    descricaoResumida: 'Um dia de banho de cachoeira na Serra Macaense para se refrescar, respirar, se conectar e simplesmente estar presente.',
    descricaoCompleta: 'Um dia de banho de cachoeira na Serra Macaense para se refrescar, respirar, se conectar e simplesmente estar presente. Conexão pura com a Mata Atlântica na Região Serrana de Macaé.',
    incluso: [
      'Transporte ida e volta saindo de Campos',
      'Guiamento Mahaflow, com cuidado, segurança e condução consciente da experiência',
    ],
    valor: 190,
    ...
    imagem: '/src/assets/experiencias/cachoeira-bicuda/capa.png',
    categoria: 'agua',
  },
  {
    id: 'carnaval-caparao',
  ...
  {
    id: 'pedra-bonita-tijuca',
    slug: 'pedra-bonita-tijuca',
    nome: 'Pedra Bonita + Floresta da Tijuca',
    data: '14 de março',
    dataISO: '2026-03-14',
    dataCompleta: '14 de março de 2026',
    diaSemana: 'Sábado',
    localPartida: 'Campos dos Goytacazes',
    conceito: 'Trilha icônica com vista panorâmica do Rio de Janeiro e imersão na maior floresta urbana do mundo.',
    oQueVaiViver: [
      'Trilha até a Pedra Bonita com vista 360°',
      'Imersão na Floresta da Tijuca',
    ...
    valor: 390,
    valorFormatado: 'R$ 390,00',
    pagamento: {},
    imagem: 'mahaflow-trilha.jpg',
    categoria: 'trilha',
  },
  {
  ...
  },
  {
    ...
    oQueVaiViver: [
      ...
      '10 corredeiras exclusivas extras — só quem vem com a Tuareg conhece',
      'Day use em base com 10.000 m² de área verde',
    ],
    descricaoResumida: 'Rafting completo com 21 quedas e corredeiras classes III e IV, day use na base, almoço buffet livre e fotos/vídeos inclusos.',
    descricaoCompleta: 'Enfrente com exclusividade as grandes quedas e as mais desafiadoras corredeiras, com surf em corredeira, flutuação e banhos de rio neste incrível percurso. São 10 corredeiras a mais que só quem vem com a Tuareg conhece! A Base Tuareg conta com um espaço de 10.000 m² de área verde, com restaurante à beira da piscina, lanchonete, bar e uma grande área de lazer com jardins, lago e diversas atrações para curtir o seu dia.',
    incluso: [
    ...
    dadosTecnicos: {
      distancia: 'Base Tuareg (10min de Três Rios) - 1h50 do RJ',
      tempo: '3h de rafting',
      nivel: 'Iniciantes e intermediários',
    },
    horarioSaida: '09h30 (horário de chegada na base)',
    informacoesImportantes: [
